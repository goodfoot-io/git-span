 ...
 * until they complete.
 *
 * Intentionally matcher-less so it fires for all agent_type values. The
 * existing subagent-start.ts (matcher: 'git-mesh:expert') continues to record
 * the expert agent id independently.
 */
