...
describe('GET /sitemap.xml', () => {
  it.skip('serves the XML content type', async () => {
    expect((await loader()).headers.get('content-type')).toBe('application/xml; charset=utf-8');
  });

  it.skip('emits exactly the homepage plus every published docs page', async () => {
  ...
  it.skip('includes the homepage and never the bare /docs redirect', async () => {
    const body = await (await loader()).text();
  ...
  it.skip('never emits renamed (redirected) docs URLs', async () => {
  ...
  it.skip('structurally excludes every machine-readable path', async () => {
  ...
  it.skip('serves the settled seven-agent robots policy from public/', () => {
  ...
  it.skip('registers the sitemap route and resolves it at runtime', () => {
  ...
  it.skip('keeps every indexable route in sync with routes.ts and the sitemap', async () => {
