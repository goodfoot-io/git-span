...
// green just washes out to near-white. The edges stay on the shared highlight color. The fill is
// lit MeshPhysicalMaterial (HDRI + clearcoat, see buildGlassBoxGroup), not a flat wash, and
