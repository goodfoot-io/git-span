...
export const artifacts = [
  {
    ...
    check: 'app/lib/content-negotiation.test.ts, app/worker.test.ts, app/lib/get-llm-text.test.ts, app/lib/homepage-markdown.test.ts (website yarn test)',
    fixCommand: null,
    banner: null,
  ...
  },
  {
    ...
    generator: 'llms(source).index() with withMdLinks in app/lib/llms-resources.ts, served by app/routes/docs.llms.txt.ts',
  ...
  },
  {
    ...
    check: 'app/lib/served-robots.test.ts fixture suite; the live check in app/test/robots-served.test.ts is skipped pending the main-257 operator action (website yarn test)',
    fixCommand: null,
    banner: null,
    bannerJustification: 'Hand-authored policy file, not generated output.',
    render: null
  },
  {
    ...
    check: 'the umbrella --check (yarn artifacts:check) plus app/routes/agent-skills.test.ts byte-identity (website yarn test)',
