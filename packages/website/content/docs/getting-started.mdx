...
This wires an in-session touch hook, a commit advisor, two skills, and an expert subagent — see [Agent integration](/docs/agent-integration) for what each piece does.
