...
- **Agent touch hook**: a `PostToolUse` hook (Claude Code and Codex) fires after supported file-affecting tool calls, healing pure positional drift inline and surfacing genuine semantic drift as context — it never blocks the tool call.
