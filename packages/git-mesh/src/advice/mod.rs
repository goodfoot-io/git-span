...
pub use session::state::{ReadRecord, TouchInterval, TouchKind, TouchProvenance, UntrackedFieldChange};
...
pub mod state {
    pub use super::session::state::{ReadRecord, TouchInterval, TouchKind, TouchProvenance, UntrackedFieldChange};
}
pub mod store {
