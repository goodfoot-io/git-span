...
fn main() -> anyhow::Result<()> {
    ...
    // The generated-artifact banner, in roff comment syntax, opening the file
    // so the manpage gate can assert it is never dropped by a future
    // generator change — the man page sits outside packages/website, where the
    // umbrella's banner bijection scan cannot see it.
    normalized.insert_str(0, ".\\\" GENERATED by gen-manpage. Do not edit by hand.\n");
