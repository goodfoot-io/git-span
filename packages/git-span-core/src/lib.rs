...
pub use span_file::{
    AnchorLineShape, CollapsedIdentity, CopyDetection, MergeSide, ResolveCommand, ResolvedRecord,
    SpanConfig, SpanMergeConflicts, SpanMergeResult, UnresolvedAnchor, carried_sentinel,
    classify_anchor_line, collapse_duplicate_identities, has_conflict_markers,
    is_rfc3339_utc_shape, merge_span_files, resolve_config, resolve_resolved_section,
    resolve_why_text,
};
pub use validation::{
