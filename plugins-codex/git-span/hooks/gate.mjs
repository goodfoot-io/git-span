...
function renderUncoveredReason(uncovered, mode = "enforce") {
  ...
  const action = 'If one exists: `git span add <name> <path#Lstart-Lend>` then `git span why <name> -m "one sentence: the subsystem, what it does across locations"`.';
