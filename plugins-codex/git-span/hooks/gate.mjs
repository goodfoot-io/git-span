...
function renderUncoveredReason(uncovered, mode = "enforce") {
  ...
  const action = 'If one exists: `git span add <name> <path#Lstart-Lend>` then `git span why <name> -m "<one present-tense sentence naming the subsystem and what it does across the anchors>"`.';
