...
(`./responding-to-drift.md`, `./creating-a-span.md`).
...
apply `./responding-to-drift.md` and `./creating-a-span.md` § "Should this be
a span?". Most uncovered writes correctly produce nothing. A record none of
