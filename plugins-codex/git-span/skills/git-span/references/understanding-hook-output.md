...
the consider-once *deny-credit* memo — it always reports whatever debt is
live right now, and it can't spend the one-time deny a later real `git
...
rather than denying, since the gate is informational and there's nothing
