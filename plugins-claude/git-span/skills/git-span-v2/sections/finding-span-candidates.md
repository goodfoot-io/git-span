...
(`plugins-claude/git-span/skills/git-span-v2/`).

**1. Mine.** From the repo root:

```bash
node plugins-claude/git-span/skills/git-span-v2/scripts/mine.mjs \
...
```bash
node plugins-claude/git-span/skills/git-span-v2/scripts/shortlist.mjs \
  --min-techniques=2
```
...
```bash
node plugins-claude/git-span/skills/git-span-v2/scripts/explain.mjs \
