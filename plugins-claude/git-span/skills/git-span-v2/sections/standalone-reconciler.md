...
prompt wins. Load the rest of the `git-span-v2` skill for judgment calls:
`SKILL.md`'s core gotchas and recipes for single-span work, `sections/triage.md`
...
resolve using `sections/triage.md`'s classification table (Moved / Changed+
