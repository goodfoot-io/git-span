...
2. One span — declaring it, re-anchoring it, or refreshing a coupled value — matches one
   of the three recipes above → do that, no section read.
3. Anything else — 2+ spans need attention, or a coupling might no longer hold at all →
   `sections/triage.md`.
