...
Claude Code plugin. Getting its hooks running takes four layers plus one
...
happen automatically. This section walks through all of them in order.
...
Codex or plugin trust -- see [git-hook-setup.md](./git-hook-setup.md) for that
installation.
