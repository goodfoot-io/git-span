...
([mod.rs](../../packages/git-span/src/cli/mod.rs#L79-L86)). This page governs
...
1. **Locate authority via the why and demonstrated intent.** A confirmed why may
   ...
   ([mod.rs](../../packages/git-span/src/cli/mod.rs#L202-L212)); commit or revert
...
- Keep the span's why across routine re-anchors; write a new one only when
  ...
  ([mod.rs](../../packages/git-span/src/cli/mod.rs#L139-L141)).
