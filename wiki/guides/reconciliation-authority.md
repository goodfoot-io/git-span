...
([mod.rs](../../packages/git-span/src/cli/mod.rs#L87-L94)). This page governs
...
1. **Locate authority via the why and demonstrated intent.** A confirmed why may
   ...
   ([mod.rs](../../packages/git-span/src/cli/mod.rs#L332-L342)); commit or revert
...
- Keep the span's why across routine re-anchors; write a new one only when
  ...
  ([mod.rs](../../packages/git-span/src/cli/mod.rs#L256-L258)).
