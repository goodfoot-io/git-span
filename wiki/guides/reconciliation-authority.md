...
([mod.rs](../../packages/git-span/src/cli/mod.rs#L76-L83)). This page governs
...
1. **Locate authority via the why and demonstrated intent.** A confirmed why may
   ...
   ([mod.rs](../../packages/git-span/src/cli/mod.rs#L199-L209)); commit or revert
...
- Keep the span's why across routine re-anchors; write a new one only when
  ...
  ([mod.rs](../../packages/git-span/src/cli/mod.rs#L136-L138)).
