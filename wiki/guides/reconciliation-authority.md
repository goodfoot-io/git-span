...
([mod.rs](../../packages/git-span/src/cli/mod.rs#L82-L89)). This page governs
...
1. **Locate authority via the why and demonstrated intent.** A confirmed why may
   ...
   ([mod.rs](../../packages/git-span/src/cli/mod.rs#L321-L331)); commit or revert
...
- Keep the span's why across routine re-anchors; write a new one only when
  ...
  ([mod.rs](../../packages/git-span/src/cli/mod.rs#L245-L247)).
