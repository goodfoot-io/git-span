...
- The [repository `CLAUDE.md` git-mesh instructions](/CLAUDE.md#L83-L104) shape how agents in this workspace are told to stage and commit meshes.
...
2. Update the primary user docs in [README.md](/README.md#L18-L55) and [CLAUDE.md](/CLAUDE.md#L83-L104).
