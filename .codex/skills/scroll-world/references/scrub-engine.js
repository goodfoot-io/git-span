/* ============================================================================
   ...
   USAGE
     mountScrollWorld(document.getElementById('world'), {
       ...
       diveScroll: 1.3,   // viewport-heights of scroll per section clip
   ...
   REQUIREMENTS ON YOUR ASSETS
     ...
     - when connectors are used, their endpoints match neighbouring clips' actual frames
...
function mountScrollWorld(container, config) {
  ...
  SECTIONS.forEach((s, i) => {
    ...
    SEGMENTS.push(dive);
    s._seg = dive;
    // A connector is optional: if connectors[i] is falsy, the two section clips
    // crossfade directly. The still-first homepage therefore works before videos return.
